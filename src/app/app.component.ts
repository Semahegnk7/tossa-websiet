...
milestones = [
  { targetValue: 50, currentValue: 0, label: 'Healthcare Institutions Served' },
  { targetValue: 20, currentValue: 0, label: 'Types of Equipment Produced' },
  { targetValue: 8, currentValue: 0, label: 'Years of Local Manufacturing' }
];
